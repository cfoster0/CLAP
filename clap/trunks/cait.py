...
class EncoderBlock(nn.Module):
    ...
    def __call__(self, inputs, is_training: bool):
        ...
        x = LayerScaleBlock(eps=self.layerscale_eps, dtype=self.dtype)(
            x, is_training=is_training
        )
        ...
        y = LayerScaleBlock(eps=self.layerscale_eps, dtype=self.dtype)(
            y, is_training=is_training
        )
    ...
    def __call__(self, inputs, is_training: bool):
        ...
        for _ in range(self.num_layers_token_only):
            cls_token = CAEncoderBlock(
                ...
                rotary_v=self.rotary_v,
                dtype=self.dtype,
            )(x, cls_token, is_training=is_training)
