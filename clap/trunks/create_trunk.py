...
def create_trunk(
    ...
    if model_name == "txt_b":
        ...
        return MLPMixer(
            output_dim=output_dim, num_layers=8, embed_dim=512, patch_shape=(32, 32)
        )
    elif model_name == "mixer_s_patch16":
        return MLPMixer(
            output_dim=output_dim, num_layers=8, embed_dim=512, patch_shape=(16, 16)
        )
    elif model_name == "mixer_b_patch32":
        return MLPMixer(
            output_dim=output_dim, num_layers=12, embed_dim=768, patch_shape=(32, 32)
        )
    elif model_name == "mixer_s_patch32":
        return MLPMixer(
            output_dim=output_dim, num_layers=12, embed_dim=768, patch_shape=(16, 16)
        )
    elif model_name == "mixer_l_patch32":
        return MLPMixer(
            output_dim=output_dim, num_layers=24, embed_dim=1024, patch_shape=(32, 32)
        )
    elif model_name == "mixer_l_patch16":
        return MLPMixer(
            output_dim=output_dim, num_layers=32, embed_dim=1024, patch_shape=(16, 16)
        )
    else:
